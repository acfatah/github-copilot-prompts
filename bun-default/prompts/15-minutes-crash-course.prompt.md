...
immediate practical value. Use fenced block for code snippets and commands. Include
tips and common pitfalls; something that need to be aware of. Prefer TypeScript.
Use `bun` for package management and runtime. Outline other topics that are related
at the end to further the study.
